...
// * DYNAMIC PATHS
// todo: [] in the file name can be used to create pages which can be accessed with dynamic values
...
// todo: It can be also set to whatever we want, and not just any value.
